            ...
            <div class="card shadow">
                <div class="card-header ">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <h3 class="mb-0">{{ __('Edit Offer') }}</h3>
                        </div>
                ...
                <div class="card-body">
                    ...
                    <form enctype="multipart/form-data" action="{{ route("offers.update", [$offer->id]) }}"
                        method="POST">
                        @csrf
                        @method('PUT')
                        <div class="form-row">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <select class="js-example-basic form-control" name="branch_id[]"
                                        ...
                                        <option value="{{$b['id']}}"
                                            {{in_array($b->id, old("branch_id",$offer->branch_id) ?: []) ? "selected": ""}}>
                                            {{$b['name']}}</option>
                                        @endforeach
                                ...
                                <div class="form-group">
                                    <label class="form-control-label"
                                        for="validationDefault01">{{__('Maximum par user:')}} <sup>leave blank to
                                            unlimited</sup></label>
                                    <input type="number" name="max_use_user"
                                        value="{{ old('max_use_user',$offer->max_use_user) }}"
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <select class="js-example-basic form-control" name="how_expire"
                                        ...
                                        <option value="0" {{$offer->how_expire == 0 ?'selected' :''}}>Using Date
                                        </option>
                                        <option value="1" {{$offer->how_expire == 1 ?'selected' :''}}>Using Maximum
                                            usage</option>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group {{$offer->how_expire != 0 ? 'd-none' :''}}" id="expiry_date">
                                    <label class="form-control-label"
                                ...
                                <div class="form-group {{$offer->how_expire != 1 ? 'd-none' :''}}" id="max_usage">
                                    <label class="form-control-label" for="validationDefault01">{{__('Max Usage:')}}
                                        <sup>All Time User Use</sup> </label>
                                    <input type="text" name="max_usage" value="{{ old('max_usage',$offer->max_usage) }}"
                            ...
                            <div class="col-md-12 mb-3">
                                <div class="form-group d-flex">
                                    ...
                                    <label class="custom-toggle custom-toggle-primary ml-2">
                                        <input {{$offer->status ? 'checked' : ''}} type="checkbox" value="1"
                                            name="status">
